        ...
        return (
            <div>
                <p>
                    ...
                    plan to run your Soteria on a cluster. For single node
                    Soteria deployments, Docker Registry is not recommended as
                ...
                <Collapse>
                    <Collapse.Panel header="More info" key="1">
                        ...
                        <p>
                            Soteria provides two methods for you to setup your
                            docker registry:
                        </p>
                        <ul>
                            <li>
                                ...
                                Soteria creates an instance of Docker Registry
